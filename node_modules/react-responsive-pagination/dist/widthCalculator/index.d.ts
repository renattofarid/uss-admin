export declare function createWidthCalculator(baseMetrics: WidthCalculatorBaseMetrics | null): ((items: import("../compositionItem.js").CompositionItem[]) => number) | {
    requiredBaseMetrics: {
...
declare function createGraph(baseMetrics: WidthCalculatorBaseMetrics): (items: import("../compositionItem.js").CompositionItem[]) => number;
