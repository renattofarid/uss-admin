...
function SchoolsPage() {
    const { open, setOpen, getData, tableSchools: tableAuthorities, loading, setSchoolSelected } = SchoolStore()
    useEffect(() => {
        getData();
    }, [])
    ...
    return (
        <main className="flex flex-col gap-4 p-4">
            <section className="">
                <h1 className="text-2xl font-semibold">Listado de Escuelas</h1>
            </section>
            ...
            <section className="flex flex-row justify-between items-center gap-2">
                ...
                <div>
                    <Button
                        ...
                        className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Nueva Escuela
                    </Button>
                    {open && <ModalSchool />}
                </div>
            </section>
